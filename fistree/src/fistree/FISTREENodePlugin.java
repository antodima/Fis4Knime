 ...
 */
public class FISTREENodePlugin extends Plugin {
    // The shared instance.
    private static FISTREENodePlugin plugin;

    /**
     * The constructor.
     */
    public FISTREENodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FISTREENodePlugin getDefault() {
        return plugin;
    }
