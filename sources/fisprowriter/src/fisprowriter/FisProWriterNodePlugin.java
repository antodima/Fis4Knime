 ...
 */
public class FisProWriterNodePlugin extends Plugin {
    // The shared instance.
    private static FisProWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public FisProWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FisProWriterNodePlugin getDefault() {
        return plugin;
    }
