 ...
 */
public class FisProReaderNodePlugin extends Plugin {
    // The shared instance.
    private static FisProReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public FisProReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FisProReaderNodePlugin getDefault() {
        return plugin;
    }
